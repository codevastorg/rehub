...
import { idlFactory } from './types_backend.did.js';
export { idlFactory } from './types_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_TYPES_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./types_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the types_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./types_backend.did.js")._SERVICE>}
 */
export const types_backend = createActor(canisterId);
