...
import { idlFactory } from './types_frontend.did.js';
export { idlFactory } from './types_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_TYPES_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./types_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the types_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./types_frontend.did.js")._SERVICE>}
 */
export const types_frontend = createActor(canisterId);
